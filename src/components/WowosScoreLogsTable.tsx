...
import { Search, Download, Calendar, Mail, User, Phone, CheckCircle, Clock } from 'lucide-react';

export const WowosScoreLogsTable = ({ logs, isLoading }: { logs: any[], isLoading: boolean }) => {
      ...
      <div className="p-4 border-b border-slate-200 flex items-center justify-between bg-white">
        <div className="relative flex-1 max-w-md">
          ...
          <input
            ...
            placeholder="Search assessment logs by name, email, or tier..."
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left border-collapse">
          ...
          <tbody className="divide-y divide-slate-100 text-xs text-slate-800">
            {isLoading ? (
              <tr><td colSpan={7} className="py-12 text-center text-slate-500">Loading assessment logs...</td></tr>
